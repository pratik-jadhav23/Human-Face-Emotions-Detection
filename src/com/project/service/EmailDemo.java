   ...
   public void sendEmail(String to)
   {
		...
		String addtext="Registration Success";
		  ...
		  Session session = Session.getDefaultInstance(props,  
		   ...
		   return new PasswordAuthentication("jadhavp785@gmail.com","project888");//change accordingly  
		   }  
		  });  
   ...
   public void sendUserPass(String to, String uname, String upass)
	   {
		   Properties props = new Properties();  
			  ...
			  Session session = Session.getDefaultInstance(props,  
			   new javax.mail.Authenticator() {  
			   protected PasswordAuthentication getPasswordAuthentication() {  
			   return new PasswordAuthentication("javaproject8@gmail.com","project888");//change accordingly  
			   }  
			  });  
